...
class Migration(migrations.Migration):
    ...
    replaces = [('exchange_rate', '0001_initial'), ('exchange_rate', '0002_exchangerate_call_date'), ('exchange_rate', '0003_auto_20220421_0938'), ('exchange_rate', '0004_exchangerateschedule'), ('exchange_rate', '0005_alter_exchangerateschedule_memo'), ('exchange_rate', '0006_auto_20220423_1944'), ('exchange_rate', '0007_auto_20220426_1006'), ('exchange_rate', '0008_auto_20220502_2139'), ('exchange_rate', '0009_rename_sales_rate_exchangerate_standard_price'), ('exchange_rate', '0010_exchangerate_country_alter_exchangerate_currency'), ('exchange_rate', '0011_alter_exchangerate_options'), ('exchange_rate', '0012_watchlist'), ('exchange_rate', '0013_exchangeratelist'), ('exchange_rate', '0014_delete_watchlist'), ('exchange_rate', '0015_alter_exchangeratelist_country_and_more'), ('exchange_rate', '0016_alter_exchangeratelist_table'), ('exchange_rate', '0017_exchangeratelist_currency_kr_and_more'), ('exchange_rate', '0018_rename_currency_exchangeratelist_name_and_more'), ('exchange_rate', '0019_rename_exchangeratelist_country'), ('exchange_rate', '0020_auto_20220603_2134')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fix_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='환율 갱신 시간')),
            ],
            options={
